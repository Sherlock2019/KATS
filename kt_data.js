...
(function (global) {
   ...
   * ------------------------------------------------------------------- */
  const CUSTOMERS = [
    { customer_id: 'hn-bank', name: 'HN-Bank Core Cloud', tier: 'Gold',
    ...
    { customer_id: 'hcmc-commerce', name: 'HCMC-Commerce Cloud', tier: 'Silver',
    ...
    { customer_id: 'dc1-shared', name: 'DC1-Shared Cloud', tier: 'Gold',
      sla_response_mins: 15, sla_resolve_mins: 240,
    ...
    { customer_id: 'dc2-shared', name: 'DC2-Shared Cloud', tier: 'Bronze',
    ...
    { customer_id: 'multisite', name: 'Multi-site Cloud', tier: 'Platinum',
